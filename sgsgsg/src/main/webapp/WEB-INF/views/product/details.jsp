...
.toast {
  z-index: 1056 !important;  /* Bootstrap의 모달보다 높게 설정 */
}
.toast-container {
  position: fixed;
  top: 20px;
...
.message {
  ...
  position: relative; /* 말풍선 꼬리를 위해 필요해 */
}
        ...
        <div class="col-md-6">
          <div class="product-info">
            ...
            <div class="product-options mb-3">
              <select class="form-select mb-2" id="option1">
                <option selected>옵션 1 선택</option>
                <option value="1" data-img="path/to/option1-1.jpg">옵션 1-1</option>
                <option value="2" data-img="path/to/option1-2.jpg">옵션 1-2</option>
              </select>
              <select class="form-select mb-2" id="option2">
                <option selected>옵션 2 선택</option>
                <option value="1" data-img="path/to/option2-1.jpg">옵션 2-1</option>
                <option value="2" data-img="path/to/option2-2.jpg">옵션 2-2</option>
              </select>
            </div>
