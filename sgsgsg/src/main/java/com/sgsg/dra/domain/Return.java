...
public class Return {
	private long return_exchange_num;
	...
	public void setReturn_exchange_num(long return_exchange_num) {
		this.return_exchange_num = return_exchange_num;
	}
	...
	public void setExchange_quantity(int exchange_quantity) {
		this.exchange_quantity = exchange_quantity;
	}
